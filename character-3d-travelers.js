...
function dagger(parent,p,r=[0,0,0]){const g=new THREE.Group();parent.add(g);g.position.set(...p);g.rotation.set(...r);rounded(.1,.58,.05,neutral.steel,g,[0,.1,0],[0,0,0],.018);rounded(.35,.08,.11,neutral.gold,g,[0,-.23,0],[0,0,0],.025);rounded(.1,.28,.1,neutral.leather,g,[0,-.39,0],[0,0,0],.03);return g}
